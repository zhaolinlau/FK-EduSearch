...
<?php require "layouts/navbar.php"?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="PostTitle" placeholder="Post Title" value="DBMS Security" disabled>
    </div>
  </div>
  <div class="form-group row">
    <label for="Feedback" class="col-sm-2 col-form-label">Expert Feedback</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="Feedback" placeholder="Expert Feedback" value="You can go find Google. Google will give you direction" disabled>
    </div>
  </div>
  <div class="form-group row">
