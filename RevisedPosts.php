<div class="col-12">
  ...
  <div class="dropdown d-flex align-items-center justify-content-center text-center">
    ...
    <ul class="dropdown-menu" aria-labelledby="filterDropdown">
      ...
      <li><a class="dropdown-item" href="./index.php?post_status=Accepted">Accepted</a></li>
      <li><a class="dropdown-item active" href="./index.php?post_status=Revised">Revised</a></li>
...
$stmt->bindParam(':revised', $revised);
$stmt->execute();
