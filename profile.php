	...
	<div class="">
		<div class="col-9 mx-auto" style="margin-right: 0;">
			...
			<div class="d-flex justify-content-between align-items-center">
				<span class="text2">Profile Page</span>
				<a href="editProfile.php" class="btn btn-light btn-sm ms-auto" style="height:fit-content;">Edit Profile</a>
			</div>
			<hr>
					...
					<div class="accordion-item">
						...
						<div id="collapseRT" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<span id="UserResearchArea"><?php echo $userData['ResearchTopic']; ?></span>
							</div>
						</div>
					</div>
				<?php endif; ?>
